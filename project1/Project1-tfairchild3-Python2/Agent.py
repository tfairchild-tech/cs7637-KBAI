...
class Agent:
    ...
    def Solve(self, problem):
        ...
        # TODO: this logic not used fully, we still check the problem list of answers instead of this var
        agtAns = AgentAnswer(problem)
        #answerlist = self.initProblemAnswerList(problem)
        ...
        # self.show_prob_answer_list(answerlist)
